...
export const STR: Record<Lang, S> = {
  ...
  ja: {
    ...
    readyTitle: 'つないで消そう',
    readyBody: '同じ色のビーズをなぞろう。<br>手数がなくなる前に、できるだけたくさん消そう。',
    legend1: '同じ色をなぞる',
    legend2: '3つ以上で消える',
    ...
    loopTag: 'その色が全部消える！',
    about:
      '色とりどりのビーズが並んだ、時間制限なしのパズルです。隣り合う同じ色のビーズをなぞって指を離すと消えます。3つ以上つなげると消え、消した数の二乗がスコアになります。使える手数は25回。すべて使い切るとゲーム終了です。',
    how: [
      'ビーズを押したまま、同じ色をなぞります。',
    ...
    tips: [
      'スコアは消した数の二乗。3つを3回消すより、10個を一度に消すほうが高得点です。',
      '何個消しても使う手数は1回だけ。早く離さず、できるだけ長くつなげましょう。',
      'すでにつないだビーズに戻って輪を作ると、その色のビーズがすべて消えます。同じ色の2×2が最短の輪です。',
    ],
  },
  es: {
